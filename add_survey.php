...
if(isset($_SESSION['login'])) {
    ...
    $survey_query_insert = "INSERT INTO survey(id, name, creator_id, date_created, description) VALUES (NULL, '$survey_name', $id_login, now(), '$survey_desc')";
    $survey_query_insert = mysqli_query($link, $survey_query_insert);

    $survey_query_select = "SELECT id FROM survey WHERE name LIKE '$survey_name'";
    ...
    for ($i = 1; $i <= $_POST['question_count']; $i++) {
        ...
        $question_query_insert = "INSERT INTO question(id, label_of_the_question, type, survey_id) VALUES (NULL, '$question_body', $question_type, $survey_id)";
        ...
        if ($question_type == 1 || $question_type == 2) {
            ...
            $answer_query_insert = "INSERT INTO answer(id, text, question_id) VALUES (NULL, '', $question_id)";
            $answer_query_insert = mysqli_query($link, $answer_query_insert);
        }
    }
}
